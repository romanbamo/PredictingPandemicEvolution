...
// ----------------------------------------------- MÈTODES PÚBLICS ------------------------------------------------------------------
    ...
    public void avançarUnDia() {
        ...
        // -------------- Calculem nous infectats a partir dels contagiosos del dia anterior -------------------------------------------
...
// ----------------------------------------------- MÈTODES PRIVATS ---------------------------------------------------------
     ...
     * esperem que morin 20 persones. Si el temps de malaltia és de 5 dies, llavors esperem que hi hagi 4 morts per dia (d'aquest grup).
     * <p>
    ...
    private void actualitzar_morts() {
        ...
        regio.persones_moren(total_morts_avui);
...
// ALTRES MÈTODES PRIVATS:
    ...
    // -----------------------------------------------------------------------------------------------------------------
    // ----------------------------------------------- MÈTODES PER LES PROVES ------------------------------------------
    // -----------------------------------------------------------------------------------------------------------------

    /** Assigna manualment l’estat dels infectats no contagiosos */
    public void posar_infectats_prova(List<Integer> llista) {
        _infectats_no_contagiosos = new ArrayList<>(llista);
    }

    /** Assigna manualment l’estat dels malalts */
    public void posar_malalts_prova(List<Integer> llista) {
        _malalts = new ArrayList<>(llista);
    }

    /** Assigna manualment l’estat de morts diàries */
    public void posar_morts_prova(List<Integer> llista) {
        mortsDiaries = new ArrayList<>(llista);
    }

    /** Assigna manualment l’estat dels contagiosos */
    public void posar_contagiosos_prova(List<Integer> llista) {
        _contagiosos = new ArrayList<>(llista);
    }

    /** Assigna manualment els valors acumulats d’infectats, malalts i morts */
...
// ====================== MÈTODES DE CONSULTA PER COMPROVAR ESTATS ======================
