...
// F -> MIREIA, VAIG COMENTANT ENMIG DEL TEU CODI !
    ...
    public void afegirAfectacioProva(Virus virus, AfectacioVirusRegio af) {
        // Pre: El virus ha de ser vàlid i no ha d'existir ja una afectació seva en aquesta regió.
        // infectats_inicials ha de ser major o igual a 0.
        // Post: S’afegeix una nova afectació a la llista d’afectacions d’aquesta regió per controlar aquest virus.

        afectacions.put(virus.nom(),af);
    }
...
// ---------------------------------------------------------------------------------------------------------------------
     ...
     * no està en la regió.
     */
    public AfectacioVirusRegio esta_present_virus_a_la_regio (Virus virus_a_buscar) {
    ...
    public List<Virus> afectacionsPresentes() {
        List<Virus> llista = new ArrayList<>();
        for (AfectacioVirusRegio af : afectacions.values()) {
            llista.add(af.quinVirusHiHa());
        }
        return llista;
    }
